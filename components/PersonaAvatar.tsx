    ...
    <section className="bg-white rounded-2xl border border-[#FDE7E0] overflow-hidden">
      <div className="px-5 py-4 border-b border-[#FDE7E0] flex items-center gap-3">
        <span
          ...
          style={{ width: 34, height: 34, border: "3px solid #FA5935", background: "#F4F2FE" }}
        >
          <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#C8431F" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            <path d="m22 8-6 4 6 4V8Z" />
            <rect width="14" height="12" x="2" y="6" rx="2" ry="2" />
          </svg>
        </span>
        <div>
          <div className="text-sm font-semibold text-[#0E1916]">Sprich per Video mit deinem KI-Ich</div>
          <div className="text-xs text-[#9A9089]">Ein sprechender Avatar deiner KI-Persona — in Echtzeit.</div>
        </div>
      </div>
      ...
      <div className="p-5">
        {state === "live" && url ? (
          <div className="space-y-3">
            <div className="relative w-full overflow-hidden rounded-xl bg-[#0E1916]" style={{ aspectRatio: "16 / 9" }}>
              <iframe
                src={url}
          ...
          <div className="rounded-xl bg-[#F4F2FE] border border-[#FDE7E0] p-4">
            <p className="text-sm font-medium text-[#0E1916]">Video-Avatar noch nicht aktiv</p>
      ...
      <p className="px-5 pb-3 text-[11px] text-[#9A9089] leading-relaxed">
